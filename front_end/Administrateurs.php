            ...
            <div class="container-fluid py-4">
                <div class="card border-0 shadow-sm overflow-auto" style="min-height: 200px; max-height: 560px; border-radius: 16px;">
                    <div class="d-flex flex-row-reverse justify-content-between align-items-center m-4">
                        ...
                        <?php include "includes_modales/Modale_administrateurs.php" ?>
                    </div>
                    <table class="table mb-0 text-center">
                        <thead>
                            <tr>
                                <th class="col-4 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">رقم الهاتف</th>
                        ...
                        <tbody>
                            <?php for($i=0 ; $i<8 ; $i++): ?>
                            <tr>
                                <td class="col-4"><?php echo "ابت" ;?></td>
                                <td class="col-4"><?php echo "ابت" ;?></td>
